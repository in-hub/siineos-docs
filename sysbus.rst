...
- read-only access publicly available
...
- each I/O signal of a I/O unit announces itself under ``iounits/<UNIT-UUID>/signals/<SIGNAL-ID>/announce`` as a JSON object containing state and meta data describing the signal instance:
