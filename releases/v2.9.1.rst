...
* New features:
    ...
    - SIGNL4 app now supports sending heartbeat messages
* Notable changes:
...
* Improvements / bugfixes:
    ...
    - Show device or hostname in browser tab title
    - Added support for new hardware revision of HUB-SE100
    - Improved reliability of internal MQTT/system bus subscriptions
* Components:
